...
var _Results = __webpack_require__(/*! ./data/Results */ "./src/data/Results.js");

var _Results2 = _interopRequireDefault(_Results);

var _ActionsObservable = __webpack_require__(/*! ./classes/ActionsObservable */ "./src/classes/ActionsObservable.js");

var _ActionsObservable2 = _interopRequireDefault(_ActionsObservable);

var _Builder = __webpack_require__(/*! ./classes/Builder */ "./src/classes/Builder.js");
...
var App = function () {
    function App() {
        ...
        this.results = new _Results2.default(this.resultsUpdatedCallback.bind(this));
        this.observable = new _ActionsObservable2.default();
        this.STATUS_COMPLETE = 'complete';
    }

    _createClass(App, [{
        key: "init",
        value: function init(observers) {
            this.initObservers(observers);
            this.initListeners();
        }
    }, {
        key: "initObservers",
        value: function initObservers(observers) {
            new _Builder2.default(this.observable, observers).build();
        }
    }, {
        key: "initListeners",
        ...
        key: "listenForTabUrlChange",
        value: function listenForTabUrlChange() {
            var _this = this;

            browser.tabs.onUpdated.addListener(function (tabId, changeInfo, tab) {
                if (!_this.isTabUrlChanged(changeInfo)) return;

                _this.searchForUrl(tabId, tab.url);
            });
        }
    }, {
        key: "listenForExternalMessages",
        value: function listenForExternalMessages() {
            browser.runtime.onMessage.addListener(this.parseMessage.bind(this));
        }
    }, {
        key: "searchForUrl",
        value: function searchForUrl(tabId, tabUrl) {
            this.results.resetResultsForTab(tabId);
            this.observable.notify(tabId, tabUrl, this.results.append.bind(this.results));
        }
    }, {
        key: "resultsUpdatedCallback",
        value: function resultsUpdatedCallback(tabId) {
            this.notifyResultsUpdated(tabId);
            this.updateBadgeText(tabId);
        }
    }, {
        key: "notifyResultsUpdated",
        value: function notifyResultsUpdated(tabId) {
        ...
        key: "updateBadgeText",
        value: function updateBadgeText(tabId) {
        ...
        key: "isTabUrlChanged",
        value: function isTabUrlChanged(changeInfo) {
...
/***/ "./src/classes/ActionsObservable.js":
/*!******************************************!*\
  !*** ./src/classes/ActionsObservable.js ***!
  \******************************************/
/*! no static exports found */
...
var _Observable2 = __webpack_require__(/*! ./Observable */ "./src/classes/Observable.js");
...
var ActionsObservable = function (_Observable) {
    ...
    function ActionsObservable() {
        _classCallCheck(this, ActionsObservable);

        return _possibleConstructorReturn(this, (ActionsObservable.__proto__ || Object.getPrototypeOf(ActionsObservable)).call(this));
    }
    ...
    _createClass(ActionsObservable, [{
        ...
        value: function notify(tabId, tabUrl, callback) {
            this.observers.forEach(function (observer) {
                observer.notify(tabId, tabUrl).then(function (results) {
...
var Builder = function () {
    function Builder(actionsObservable, observers) {
    ...
    _createClass(Builder, [{
        ...
        value: function build() {
            ...
            this.observers.forEach(function (observer) {
                _this.actionsObservable.subscribe(new observer());
            }, this);
        }
    }]);
...
var Results = function () {
    function Results(resultsUpdatedCallback) {
        _classCallCheck(this, Results);

        if (typeof resultsUpdatedCallback !== 'function') throw Error('Results callback is not a function');
    ...
    _createClass(Results, [{
        key: 'getResultsForTab',
        value: function getResultsForTab(tabId) {
            if (!this.results.hasOwnProperty(tabId)) throw Error('No results found for #' + tabId + ' tab id');

            return this.results[tabId];
        }
    }, {
        key: 'hasResultsForTab',
        value: function hasResultsForTab(tabId) {
            return this.results.hasOwnProperty(tabId);
        }
    }, {
        key: 'append',
        value: function append(tabId, results) {
        ...
        key: 'parse',
        value: function parse(tabId) {
            this.results[tabId] = this.results[tabId].sort(function (result1, result2) {
        ...
        key: 'concat',
        value: function concat(tabId, results) {
            this.results[tabId] = this.results[tabId].concat(results);
        }
    }, {
        key: 'initializeResultsArray',
        value: function initializeResultsArray(tabId) {
            if (!this.results.hasOwnProperty(tabId)) {
                this.results[tabId] = [];
            }
        }
    }, {
        key: 'resetResultsForTab',
        value: function resetResultsForTab(tabId) {
            if (this.results.hasOwnProperty(tabId)) delete this.results[tabId];
        }
    }]);
...
var _HnObserver = __webpack_require__(/*! ./observers/HnObserver */ "./src/observers/HnObserver.js");

var _HnObserver2 = _interopRequireDefault(_HnObserver);

var _RedditObserver = __webpack_require__(/*! ./observers/RedditObserver */ "./src/observers/RedditObserver.js");

var _RedditObserver2 = _interopRequireDefault(_RedditObserver);
...
var HN_SEARCH_URL_FORMAT = 'https://hn.algolia.com/api/v1/search?query={url}&restrictSearchableAttributes=url';
var HN_URL_FORMAT = 'https://news.ycombinator.com/item?id={objectID}';

var HnObserver = function (_Observer) {
    _inherits(HnObserver, _Observer);

    function HnObserver() {
        _classCallCheck(this, HnObserver);
    ...
    _createClass(HnObserver, [{
        key: 'notify',
        value: function notify(tabId, tabUrl) {
            var _this2 = this;

            return new Promise(function (resolve, reject) {
                _axios2.default.get(HnObserver.getFullUrl(tabUrl)).then(function (response) {
        ...
        key: 'getHNUrl',
        value: function getHNUrl(objectID) {
...
exports.default = HnObserver;
module.exports = exports['default'];

/***/ }),

/***/ "./src/observers/Observer.js":
/*!***********************************!*\
  !*** ./src/observers/Observer.js ***!
  \***********************************/
/*! no static exports found */
...
/***/ "./src/observers/RedditObserver.js":
/*!*****************************************!*\
  !*** ./src/observers/RedditObserver.js ***!
  \*****************************************/
/*! no static exports found */
...
var REDDIT_SEARCH_URL_FORMAT = 'https://www.reddit.com/api/info.json?url={url}';
var REDDIT_URL_FORMAT = 'https://www.reddit.com{permalink}';

var RedditObserver = function (_Observer) {
    _inherits(RedditObserver, _Observer);

    function RedditObserver() {
        _classCallCheck(this, RedditObserver);
    ...
    _createClass(RedditObserver, [{
        ...
        key: 'searchUrl',
        value: function searchUrl(url, successCallback) {
        ...
        key: 'getRedditUrl',
        value: function getRedditUrl(permalink) {
            return REDDIT_URL_FORMAT.replace('{permalink}', permalink);
        }
    }]);

    return RedditObserver;
}(_Observer3.default);

exports.default = RedditObserver;
module.exports = exports['default'];
